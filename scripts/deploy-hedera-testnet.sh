...
echo ""
echo "Next:"
echo "  1. Verify on HashScan (optional, before wiring): ./scripts/verify-hedera-testnet.sh $AGGREGATOR"
echo "  2. Set Controller and Oracle: cast send $AGGREGATOR \"setController(address)\" <CONTROLLER_ADDRESS> --rpc-url $RPC_URL --private-key \$HEDERA_PRIVATE_KEY"
